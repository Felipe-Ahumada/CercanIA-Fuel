...
import cl.bencinaenlinea.finanzas.application.dto.*;
import cl.bencinaenlinea.finanzas.application.service.DescuentoService;
...
public class DescuentoController {
    ...
    public List<DescuentoResponse> listarPorMarca(@RequestParam @Positive Integer marcaId) {
        return descuentoService.listarPorMarca(marcaId);
    }

    @GetMapping("/{id}")
    @Operation(summary = "Obtener descuento por ID")
    public DescuentoResponse buscar(@PathVariable Integer id) {
        return descuentoService.buscarPorId(id);
    }

    @PostMapping
    @Operation(summary = "Crear un descuento")
    public ResponseEntity<DescuentoResponse> crear(@Valid @RequestBody DescuentoCreateRequest req,
                                                   UriComponentsBuilder uriBuilder) {
        DescuentoResponse creado = descuentoService.crear(req);
    ...
    public DescuentoResponse actualizar(@PathVariable Integer id,
                                        @Valid @RequestBody DescuentoUpdateRequest req) {
    ...
    public DescuentoCalculadoResponse calcular(@Valid @RequestBody CalcularDescuentoRequest req) {
